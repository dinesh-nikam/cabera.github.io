      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {currentStep === "confirmation" && (
            <ConfirmationStep bookingId="PMCB-2026-001" />
          )}
        </motion.div>
      </AnimatePresence>
    </div>
        ...
        <div className="flex flex-wrap gap-2">
          {popularLocations.map((location) => (
            <button
              ...
              className="px-3 py-1 text-sm bg-luxury-400/10 hover:bg-luxury-400/20 rounded-full transition-colors"
            >
              {location}
            </button>
          ))}
        ...
        <div className="glass p-5 rounded-xl border border-white/5 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 max-w-[150px] mx-auto bg-background/50 p-4 rounded-xl border border-white/5 relative">
                {/* Steering wheel */}
                <div className="absolute top-2 left-3 w-4 h-4 rounded-full border border-white/20 border-t-white/80 animate-spin-slow" />
            ...
            <div>
              ...
              <div className="flex gap-2 justify-center bg-background/50 p-4 rounded-xl border border-white/5">
  ...
  return (
    <div className="text-center py-8">
      ...
      <div className="flex gap-3">
        ...
        <AnimatedButton className="flex-1">Track Ride</AnimatedButton>
      </div>
    </div>
  );
}
