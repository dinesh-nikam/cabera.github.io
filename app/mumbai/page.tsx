...
export default function MumbaiPage() {
  ...
  const coverageAreas = [
    { name: "Andheri Hub", route: "/andheri-cab-service" },
    { name: "Bandra BKC Complex", route: "/bandra-cab-service" },
    { name: "Powai Commercial Hub", route: "/powai-cab-service" },
    { name: "Thane Corridor Hub", route: "/thane-cab-service" },
    { name: "Navi Mumbai Junction", route: "/navi-mumbai-cab-service" },
    { name: "Panvel Terminal Hub", route: "/panvel-cab-service" },
  ];

  const popularRoutes = [
    {
      to: "Pune Expressway Hub",
      price: "2,500",
    ...
    <main className="min-h-screen bg-background relative">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-10">
          <div className="absolute top-1/2 right-1/4 w-[600px] h-[600px] rounded-full bg-luxury-400 blur-[150px] pointer-events-none" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold font-heading text-white leading-tight">
                Mumbai Chauffeur & Outstation Services
              </h1>
              <p className="text-lg text-text-secondary leading-relaxed font-body">
                First-class ground transportation across the commercial center
                of Mumbai. Dedicated airport transfers to Terminal 2, BKC
                corporate complexes, Powai, and express outstation travel.
              </p>
            ...
            <div className="lg:col-span-5 flex justify-center">
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1566552881560-0be862a7c445?q=80&w=800"
                  alt="Mumbai Skyline Marine Drive"
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16 space-y-2">
            ...
            <h2 className="text-3xl md:text-5xl font-bold font-heading text-white">
              Coverage Zones in Mumbai
            </h2>
            <p className="text-text-secondary text-sm max-w-lg mx-auto">
              We service all corporate terminals, hotel corridors, and
              high-density zones.
            </p>
          </div>
